...
## 2026-09-01 知识编译（已有来源复审·补强）

- 复核三条已摄取语音（2025-02-20 李斯、2025-02-25 每日操作系统、2025-05-12 自由与必然），现有页面主干均已覆盖，无需新建页面。
- 补强 [[wiki/concepts/positioning-and-agency]]：在“主动权”一节新增“读信号、定位置”与“屏左右”两个可复用谈判细节（李斯从传话用“请”还是“叫”校准自身分量；主动请求屏卫左右、独自密谈以保神秘并约束风险）。
