...
<p class="xw-lead">把低摩擦的语音捕捉，转化为可追溯、可连接、会持续生长的长期知识。iPhone 负责记录，Mac 在本地完成转写和编译，公开页面只呈现知识层。</p>

<div class="xw-status">
  <div><strong>本地转写</strong><span>Apple MLX · Whisper Large V3 Turbo</span></div>
  <div><strong>知识编译</strong><span>pi · iagent/standard · x-wiki-compiler</span></div>
  <div><strong>发布边界</strong><span>GitHub Pages 仅发布 Wiki，raw 留在本机</span></div>
</div>
